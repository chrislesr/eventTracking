var currentPage = 1;
        ...
        function fetchData(page) {
            var search = document.getElementById("search_text_rfid").value;
            var control = document.getElementById("control").value;
            var xhr = new XMLHttpRequest();
            xhr.open("GET", "fetch_data.php?page=" + page + "&rowsPerPage=" + rowsPerPage + "&search=" + search + "&control=" + control, true);
        ...
        document.getElementById("search_text_rfid").addEventListener("keyup", function() {
